...
const luisConfig: LuisApplication = { applicationId: LuisAppId, endpointKey: LuisAPIKey, endpoint: LuisAPIHostName };

const luisRecognizer = new InterviewBotRecognizer(luisConfig);
